...
/* Calibrated AWB gains from HI556_H8B5_ADL.aiqb (daylight ~5024K) */
#define HI556_AWB_R_GAIN		511	/* ~1.9966 * 256 */
#define HI556_AWB_B_GAIN		382	/* ~1.4936 * 256 */
...
{
int ret;
u32 r_gain = d_gain * HI556_AWB_R_GAIN / 256;
u32 b_gain = d_gain * HI556_AWB_B_GAIN / 256;
...
ret = hi556_write_reg(hi556, HI556_REG_MWB_R_GAIN,
      HI556_REG_VALUE_16BIT, r_gain);
if (ret)
return ret;

return hi556_write_reg(hi556, HI556_REG_MWB_B_GAIN,
       HI556_REG_VALUE_16BIT, b_gain);
}
